...
public class Menu1 implements ActionListener
{
   ...
   private JMenu m_archivo, m_edicion, m_modulo;
   ...
   private JMenuItem mm_contabilidad, mm_facturacion;
   ...
   Menu1()
   {
      ...
      m_modulo = new JMenu("Modulo");

      mm_contabilidad = new JMenuItem("Contabilidad");
      mm_contabilidad.addActionListener(this);
      m_modulo.add(mm_contabilidad);
   
      mm_facturacion = new JMenuItem("Facturacion");
      mm_facturacion.addActionListener(this);
      m_modulo.add(mm_facturacion);

      menuBar.add(m_modulo);
   ...
   public void actionPerformed(ActionEvent e)
   {
      ...
      if (e.getSource() == mm_contabilidad)
         new Contabilidad(ventana);

      if (e.getSource() == mm_facturacion)
